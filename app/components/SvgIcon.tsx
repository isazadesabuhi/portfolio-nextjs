...
const SVGs = {
  ...
  arrowDown: ({ fill, fillOpacity }: { fill?: string; fillOpacity?: string }) => (
    <svg
                        viewBox="0 0 16 16"
                        fill="none"
                        aria-hidden="true"
  ...
  work: ({ fill, fillOpacity }: { fill?: string; fillOpacity?: string }) => (
    <svg
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke-width="1.5"
  ...
  letter: ({ fill, fillOpacity }: { fill?: string; fillOpacity?: string }) => (
    <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke-width="1.5"
